...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2023 a las 00:10:51
...
CREATE TABLE `producto` (
  `idProducto` int(11) NOT NULL,
  `nombrePorducto` varchar(100) NOT NULL,
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`idProvedor`) REFERENCES `provedor` (`idProveedor`);
